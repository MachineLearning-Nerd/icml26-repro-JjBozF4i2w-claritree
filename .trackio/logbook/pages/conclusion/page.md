...
---
<!-- trackio-cell
{"type": "markdown", "id": "cell_0715105c5fde", "created_at": "2026-07-22T10:45:05+00:00", "title": "Executive summary"}
-->
## Outcome

C1--C4 are source-backed and independently checked; C6 is verified for its direction with its exact released values disclosed. C5 is explicitly excluded because the source protocol is incomplete.

## Scope & cost

| Scope | Hardware | Time | Cost | Outcome |
| --- | --- | --- | --- | --- |
| This reproduction | Local CPU plus HF cpu-upgrade | Outer-4 source fit 62.04s | CPU only | C1-C4 pass; C6 qualified |
| Full replication | Author 48-core / 768GB protocol | 600s budget per run | Not claimed | C5 cannot be source-rerun from release |


---
<!-- trackio-cell
{"type": "code", "id": "cell_a78fe585d440", "created_at": "2026-07-22T10:45:22+00:00", "title": "Fail-closed publication gate", "command": ["python", "repro/src/run_publication_gate.py"], "exit_code": 0, "duration_s": 2.054, "pinned": true, "pinned_at": "2026-07-22T10:45:36+00:00"}
-->
````bash
...
````output
{
  ...
  "excluded_anchored_claims": {
    "C5": "source protocol missing; see docs/C5_SCOPE_EXCLUSION.md"
  },
  "c6_disclosure": {
    "exact_release_endpoint_percent": {
      "claritree": 100.0,
  ...
  "checks": {
    "source_pins": {
      "passed": true,
      "detail": "{\n  \"upstream\": {\n    \"commit\": \"4397f8dbc8b63751777e7918b89972e793796dfd\",\n    \"dirty\": \"false\"\n  },\n  \"repro/vendor/eigen\": {\n    \"commit\": \"3147391d946bb4b6c68edd901f2add6ac1f31f8c\",\n    \"dirty\": \"false\"\n  }\n}"
    },
    "source_structure_c1": {
      "passed": true,
    ...
    "cpu_demo_memory_calibration": {
      "passed": true,
      "detail": "retained pinned CPU calibration artifact is valid"
    },
    "cpu_fixed_split_c4_calibration": {
      "passed": true,
      "detail": "fixed-split test_r2 matches committed outer_4 result (0.743132723)"
    },
    "c5_scope_exclusion": {
      "passed": true,
      "detail": "docs/C5_SCOPE_EXCLUSION.md"
    }
  },
  "tests_passed": true,
