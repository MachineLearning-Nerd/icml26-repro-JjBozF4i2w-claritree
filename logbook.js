(function () {
  ...
  const LEGACY_SLUGS = {
    ...
    "claim-c1-c3": "claim-1-rank-one-cholesky-updates",
    "claim-c4": "claim-4-california-housing",
    "claim-c5-scope": "claim-5-synthetic-result",
    "claim-c6": "claim-6-completion-budget",
    "negative-controls": "claim-3-dominance-and-gap",
  };
  ...
  function registerFigureNavigation(frame) {
    ...
    frame.addEventListener("load", () => {
      registerFrameWindow();
      if (location.hash) {
        requestAnimationFrame(() => scrollToHash({ behavior: "auto" }));
      }
    });
    registerFrameWindow();
